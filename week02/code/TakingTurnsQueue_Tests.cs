...
public class TakingTurnsQueueTests
{
    ...
    // Defect(s) Found: Sue is being dequeued first rather than bob
    ...
    // Run 10 times.
    // Expected Result: Bob, Tim, Sue, Bob, Tim, Sue, Tim, Sue, Tim, Tim
    // Defect(s) Found: People that are added with 0 turns should have an infinite amount of turns but they don't
